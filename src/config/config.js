...
export const API_BASE_URL = "http://olvin.bonaquian.com/movil2"; //base de datos nube
//export const API_BASE_URL = "http://localhost/movil2"; //base de datos en casa
//export const API_BASE_URL = "http://192.168.100.126/movil2"; //base de datos en mi celular
